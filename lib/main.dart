...
class HomeUtama extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            Text('Kriteria Suami Idaman',style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold)),
            ListView(
              children: <Widget>[
                _itemMenuUtama(context, "Apa Itu Haji?", TampilIdaman())
              ],
            )
          ],
        )
